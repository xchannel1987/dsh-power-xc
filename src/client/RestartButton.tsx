      ...
      {open ? (
        ...
        >
          ...
          <MenuItem
            ...
            glyph={
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true" style={{ flex: '0 0 auto' }}>
                <path d="M20 12a8 8 0 1 1-2.12-5.28" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" />
                <path d="M20 3v4.5h-4.5" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            }
          />
          <MenuItem
